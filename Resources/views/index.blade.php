@extends('pingpongthemes::themes.flat.layouts.default')
...
<section class="home-title">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <h3>Flat Theme for Laravel implemented as Pingpong Module</h3>
            ...
            <div class="col-sm-7 col-sm-offset-1 player-wrapper">
                <div class="player">
                    <iframe src="https://www.youtube.com/embed/lJcGzmsLRUo" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
...
<section class="logos">
    <div class="container">
        <div><img src="{{ Module::asset('pingpongthemes:images/logos/mashable.png') }}" alt=""></div>
        <div><img src="{{ Module::asset('pingpongthemes:images/logos/guardian.png') }}" alt=""></div>
        <div><img src="{{ Module::asset('pingpongthemes:images/logos/forbes.png') }}" alt=""></div>
        <div><img src="{{ Module::asset('pingpongthemes:images/logos/red-bull.png') }}" alt=""></div>
        <div><img src="{{ Module::asset('pingpongthemes:images/logos/ny-times.png') }}" alt=""></div>
    </div>
</section>
